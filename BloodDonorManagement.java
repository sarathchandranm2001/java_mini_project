...
public class BloodDonorManagement {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3306/sarath_db";
   ...
   /*  private static void initializeDatabase() {
    ...
    private static void registerDonor(Scanner scanner) {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sarath_db?characterEncoding=utf8", "root", "Sarath@9747");
